...
imagen=PhotoImage(file="fondo_ventana.png")
...
menuProcesamientoGlobalImagenes=Menu(barraMenu)

menuProcesamientoGlobalImagenes.add_command(label="Estructura .bmp",command=decodificar_bmp)
menuProcesamientoGlobalImagenes.add_command(label="rgb a grises",command=grises)
menuProcesamientoGlobalImagenes.add_command(label="Contraste",command=contraste)
menuProcesamientoGlobalImagenes.add_command(label="Ecualizar",command=ecualiza)
menuProcesamientoGlobalImagenes.add_command(label="Brillo",command=brillar)
menuProcesamientoGlobalImagenes.add_command(label="Umbralizar",command=umbralizado)

menuTransformacionesLocales=Menu(barraMenu)

menuTransformacionesLocales.add_command(label="Suavizar",command=suavizado)
menuTransformacionesLocales.add_command(label="Filtro_Promedio",command=filtro_promedio)
menuTransformacionesLocales.add_command(label="Difuminada",command=difuminar)
menuTransformacionesLocales.add_command(label="Bordes",command=bordes)
menuTransformacionesLocales.add_command(label="Ejemplo_Bordes",command=ej_bordes)
menuTransformacionesLocales.add_command(label="Filtro_Sobel",command=sobel)
menuTransformacionesLocales.add_command(label="Filtro_Laplace",command=laplace)
menuTransformacionesLocales.add_command(label="Filtro_Gaussiano",command=filtro_gaussiano)
menuTransformacionesLocales.add_command(label="Filtro_Mediana",command=mediana)
menuTransformacionesLocales.add_command(label="Dilatada",command=dilatacion)
menuTransformacionesLocales.add_command(label="Erosionada",command=erosion)
menuTransformacionesLocales.add_command(label="Cierre",command=cierre)
menuTransformacionesLocales.add_command(label="Apertura",command=apertura)
menuTransformacionesLocales.add_command(label="Esqueletizada",command=esqueletizacion)

menuTransformacionesGeometricas=Menu(barraMenu)

menuTransformacionesGeometricas.add_command(label="Rotacion",command=rotacion)
menuTransformacionesGeometricas.add_command(label="Traslación",command=traslacion)
menuTransformacionesGeometricas.add_command(label="Transformación Afin",command=trans_afin)

menuDominioFrecuencial=Menu(barraMenu)

menuDominioFrecuencial.add_command(label="TransformadaWavelet",command=trans_wavelet)

barraMenu.add_cascade(label="Archivo",menu=menuArchivo)
barraMenu.add_cascade(label="Proc_GlobalImagenes",menu=menuProcesamientoGlobalImagenes)
barraMenu.add_cascade(label="Trans_Locales",menu=menuTransformacionesLocales)
barraMenu.add_cascade(label="Trans_Geometricas",menu=menuTransformacionesGeometricas)
barraMenu.add_cascade(label="Dominio Frecuencial",menu=menuDominioFrecuencial)
